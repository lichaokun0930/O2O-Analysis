...
from .orders_analysis import router as orders_analysis_router
from .orders_delivery import router as orders_delivery_router
...
router.include_router(orders_analysis_router, prefix="/orders", tags=["订单分析-品类"])
router.include_router(orders_delivery_router, prefix="/orders", tags=["订单分析-配送"])
