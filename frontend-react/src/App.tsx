...
import CostStructureChart from './components/charts/ProfitChart';
import HourlyAnalysisChart from './components/charts/CostEfficiencyChart';
...
// 🆕 营销成本趋势图表（与桑基图互补）
import MarketingTrendChart from './components/charts/MarketingTrendChart';
import ProfitSimulator from './components/ProfitSimulator';
import AIInsightsPanel from './components/AIInsightsPanel';
import DataTable from './components/DataTable';
import AICommandBar from './components/AICommandBar';
// 懒加载 DataManagement 组件
const DataManagement = React.lazy(() => import('./views/DataManagement'));
// 懒加载 StoreComparisonView 组件
const StoreComparisonView = React.lazy(() => import('./views/StoreComparisonView'));
// 🆕 图表联动组件
import CategoryTrendChart from './components/charts/CategoryTrendChart';
import TopProductsChart from './components/charts/TopProductsChart';
import CategoryHealthTable from './components/charts/CategoryHealthTable';
// 🆕 分距离订单诊断图表（Checkpoint 6 验证）
import DistanceAnalysisChart from './components/charts/DistanceAnalysisChart';
...
function Dashboard({ theme }: { theme: 'dark' | 'light' }) {
  ...
  const fetchMarketingTrend = useCallback(async () => {
    console.log('📈 fetchMarketingTrend 调用, selectedStore:', selectedStore);
    if (!selectedStore) {
      console.log('📈 未选择门店，跳过营销趋势数据加载');
  ...
  return (
      <div className={`flex flex-col gap-6 relative z-10 w-full transition-all duration-500`}>
        ...
        <div className="grid grid-cols-12 gap-6 w-full pb-12">
            ...
            {/* Row 1: 6个核心指标卡片 - 与Dash版本一致 */}
            {/* 环比显示逻辑：有环比数据时显示，无数据时显示"无数据" */}
            <div className={`col-span-6 lg:col-span-2 animate-fade-in-up stagger-1`}>
                <StatCard 
                    title="订单总数" 
            ...
            <div className={`col-span-6 lg:col-span-2 animate-fade-in-up stagger-2`}>
                <StatCard 
                    title="商品实收额" 
            ...
            <div className={`col-span-6 lg:col-span-2 animate-fade-in-up stagger-3`}>
                <StatCard 
                    title="总利润" 
            ...
            <div className={`col-span-6 lg:col-span-2 animate-fade-in-up stagger-4`}>
                <StatCard 
                    title="平均客单价" 
            ...
            <div className={`col-span-6 lg:col-span-2 animate-fade-in-up stagger-5`}>
                <StatCard 
                    title="总利润率" 
            ...
            <div className={`col-span-6 lg:col-span-2 animate-fade-in-up stagger-6`}>
                <StatCard 
                    title="动销商品数" 
            ...
            {/* Row 2: Trend Chart + AI Panel - Uses Filtered Data */}
            <div ref={trendRef} className={`col-span-12 xl:col-span-8 h-[550px] animate-fade-in-up stagger-7 ${getFocusClass('trend')}`}>
            ...
            <div className="col-span-12 xl:col-span-4 h-[550px] animate-fade-in-up stagger-8 z-30">
